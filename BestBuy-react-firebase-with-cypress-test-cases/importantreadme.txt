1 . Make sure to register one account for our testing purpose as well before you submit 
...
2. Initial price state in slider filter should be 75000 , as the minimum and maximum should be 1 and 100000




3. Make sure when you connect with firebase and start your react app , it automatically posts these provided data , you also add your own in this as well but make sure to add these first 
   const data = [
  {
    id: 1,
...
4. We have to use react-router-dom to navigate through Home , My Orders , Cart , Signin . the My Orders and Cart should be protected
   shouldnt be shown unless the user is loginned . 
   the ending name of routes should be as follows
  - "/" which is index element should render the HomePage component , which should have all the products , search bar , and the filter
